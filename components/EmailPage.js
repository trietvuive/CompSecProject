	...
	<>
      ...
      <div className="details">
        ...
        <div className="header">
          <img className="avatar" src="https://bootdey.com/img/Content/avatar/avatar1.png"/>
          <div className="from">
        ...
        <div className="content">
          ...
          <blockquote>
            ...
            in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
				...
				<button tabIndex="3" type="submit" className="btn btn-success">Accept</button>
				<button tabIndex="6" type="submit" className="btn btn-success">Deny</button>
      </div>
    </main>
	</>
	)
